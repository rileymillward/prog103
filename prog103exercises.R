...
get_y_value <- function(age_class) {
  if (age_class == "egg") {
    y <- 10
  } else if (age_class == "larva") {
    y <- 5
...
print(get_y_value("egg"))
print(get_y_value("larva"))
print(get_y_value("adult"))
print(get_y_value("senescent"))
...
# Define species-specific constants
a <- 5.243e-6
b <- 3.141

fork_lengths <- c(100, 200, 300)

masses <- a * fork_lengths^b
...
fork_lengths <- c(100, 200, 300)
shortfin_mako_mass_kg(fork_lengths)
